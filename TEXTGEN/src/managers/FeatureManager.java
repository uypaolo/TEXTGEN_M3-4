...
public class FeatureManager{
		...
		if(featureMap == null){			
			...
			try{
				...
				for(Element componentElement: componentElements){
					...
					featureMap.put(componentElement.getAttributeValue("name"), featureValuesList);
				}
	...
	public static ArrayList<Feature> getDefaultFeatures(String componentName){
		//InitializeDefaults
		ArrayList<DBFeatureValues> featureValuesList = getFeatureMap().get(componentName);
	...
	public static DBFeatureValues getFeatureValues(String componentName, String featureName){
		ArrayList<DBFeatureValues> featureValues = getFeatureMap().get(componentName);
